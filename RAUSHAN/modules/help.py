...
HELP_STRING = f"★ Pʀᴏғᴇssᴏʀ Hᴇʟᴘ Mᴇɴᴜ ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @PROFESSOR_77X**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/PROFESSOR_77XX"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/+qYRBJgZsARpkNWJl")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/e6fc25f72bda17fd3c712.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Altron Bots !! @PROFESSOR_77X", cache_time=0, alert=True)
